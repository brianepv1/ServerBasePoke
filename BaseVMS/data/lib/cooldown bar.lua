...
-- Sistema de Guardian - Thalles Vitor (pedaço do meu codigo)
local summons = getCreatureSummons(cid)
if summons[1] and string.find(getCreatureName(summon), "Guardian") then
	summon = getCreatureSummons(cid)[2]
end

if summons[2] and string.find(getCreatureName(summon), "Guardian") then
