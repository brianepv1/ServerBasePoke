...
tempo = 120, -- em minutos
itemid = 2160,
price = 1, -- quantidade de dinheiro que irá custar
level = 50 -- level pra poder utilizar o broadcast
}
...
doPlayerSendCancel(cid, "You don't have " ..config.price.. " Dollar's Você não tem Dinheiro Suficiente para uzar o anuncio.")
return true
end
else
