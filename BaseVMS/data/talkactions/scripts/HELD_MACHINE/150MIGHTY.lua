...
-- 150X MIGHTY TOKENS --
if getPlayerItemCount(cid, 24150) >= 150 then

-- REMOVE 150X MIGHTY TOKENS --
doPlayerRemoveItem(cid, 24150, 150)
...
doPlayerSendTextMessage(cid, 26, "Você precisa de 150x Mighty Tokens para fazer isso.")
return true
end
end