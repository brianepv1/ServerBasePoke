...
-- CURE TIER 7 --
if getPlayerItemCount(cid, 13989) >= 1 then

-- CURE TIER 7 --
doPlayerRemoveItem(cid, 13989, 1)
...
doPlayerSendTextMessage(cid, 26, "Você precisa de um Y-Cure (Tier: 7) para trocar por um Held Fusion Point (Tier: 7).")
return true
end
end