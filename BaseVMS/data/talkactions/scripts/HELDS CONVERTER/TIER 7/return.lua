-- HELD CONVERTER: X-RETURN TIER 7 --
...
-- RETURN TIER 7 --
if getPlayerItemCount(cid, 13975) >= 1 then

-- RETURN TIER 7 --
doPlayerRemoveItem(cid, 13975, 1)
...
doPlayerSendTextMessage(cid, 26, "Você precisa de um X-Return (Tier: 7) para trocar por um Held Fusion Point (Tier: 7).")
return true
end
end