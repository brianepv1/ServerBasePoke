-- HELD CONVERTER: X-RETURN TIER 3 --
...
-- RETURN TIER 3 --
if getPlayerItemCount(cid, 13971) >= 1 then

-- RETURN TIER 3 --
doPlayerRemoveItem(cid, 13971, 1)
...
doPlayerSendTextMessage(cid, 26, "Você precisa de um X-Return (Tier: 3) para trocar por um Held Fusion Point (Tier: 3).")
return true
end
end