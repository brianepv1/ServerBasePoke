-- HELD CONVERTER: X-RETURN TIER 2 --
...
-- RETURN TIER 2 --
if getPlayerItemCount(cid, 13970) >= 1 then

-- RETURN TIER 2 --
doPlayerRemoveItem(cid, 13970, 1)
...
doPlayerSendTextMessage(cid, 26, "Você precisa de um X-Return (Tier: 2) para trocar por um Held Fusion Point (Tier: 2).")
return true
end
end