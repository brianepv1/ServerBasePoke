-- HELD CONVERTER: X-RETURN TIER 6 --
...
-- RETURN TIER 6 --
if getPlayerItemCount(cid, 13974) >= 1 then

-- RETURN TIER 6 --
doPlayerRemoveItem(cid, 13974, 1)
...
doPlayerSendTextMessage(cid, 26, "Você precisa de um X-Return (Tier: 6) para trocar por um Held Fusion Point (Tier: 6).")
return true
end
end