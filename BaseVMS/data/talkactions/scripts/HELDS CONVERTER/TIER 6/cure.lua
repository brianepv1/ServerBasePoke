...
-- CURE TIER 6 --
if getPlayerItemCount(cid, 13988) >= 1 then

-- CURE TIER 6 --
doPlayerRemoveItem(cid, 13988, 1)
...
doPlayerSendTextMessage(cid, 26, "Você precisa de um Y-Cure (Tier: 6) para trocar por um Held Fusion Point (Tier: 6).")
return true
end
end