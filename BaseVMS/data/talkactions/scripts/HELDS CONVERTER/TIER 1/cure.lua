...
-- CURE TIER 1 --
if getPlayerItemCount(cid, 13983) >= 1 then

-- CURE TIER 1 --
doPlayerRemoveItem(cid, 13983, 1)
...
doPlayerSendTextMessage(cid, 26, "Você precisa de um Y-Cure (Tier: 1) para trocar por um Held Fusion Point (Tier: 1).")
return true
end
end