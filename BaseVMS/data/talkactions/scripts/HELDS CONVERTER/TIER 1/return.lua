-- HELD CONVERTER: X-RETURN TIER 1 --
...
-- RETURN TIER 1 --
if getPlayerItemCount(cid, 13969) >= 1 then

-- RETURN TIER 1 --
doPlayerRemoveItem(cid, 13969, 1)
...
doPlayerSendTextMessage(cid, 26, "Você precisa de um X-Return (Tier: 1) para trocar por um Held Fusion Point (Tier: 1).")
return true
end
end