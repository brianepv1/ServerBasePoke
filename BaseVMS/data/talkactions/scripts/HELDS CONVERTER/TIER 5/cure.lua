...
-- CURE TIER 5 --
if getPlayerItemCount(cid, 13987) >= 1 then

-- CURE TIER 5 --
doPlayerRemoveItem(cid, 13987, 1)
...
doPlayerSendTextMessage(cid, 26, "Você precisa de um Y-Cure (Tier: 5) para trocar por um Held Fusion Point (Tier: 5).")
return true
end
end