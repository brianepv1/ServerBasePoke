...
-- CURE TIER 4 --
if getPlayerItemCount(cid, 13986) >= 1 then

-- CURE TIER 4 --
doPlayerRemoveItem(cid, 13986, 1)
...
doPlayerSendTextMessage(cid, 26, "Você precisa de um Y-Cure (Tier: 4) para trocar por um Held Fusion Point (Tier: 4).")
return true
end
end