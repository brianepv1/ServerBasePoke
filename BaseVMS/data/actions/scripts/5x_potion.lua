function onUse(cid, item, frompos, item2, topos)
    ...
    local texto = 'Boost experience at 50% for 30 minutes.' -- Texto que  receber ao usar a potion.
    textofinal = 'Boost experience done.' -- Texto que ira receber quando o efeito da potion acabar.
    local exp = 185 -- O quanto que voce quer que dobre sua experiencia, por exemplo 2 is 2%  as rates do seu server.
