...
local txt = {
["rock smash"] = {"Quebra essa pedra!", "Quebre essa rocha!", "Destruir essa rocha!", "Esmagá Aquela Pedra!", "Quebre a Rocha!", "Destruía Aquela Pedra"},
["cut"] = {"Corte esse arbusto!", "Use Cortar!", "Corte-o!", "Corte esse arbusto!", "Use Cut!", "Corte esse arbusto!"},
["move"] = {"Use mover!", "vá para lá!", "vá ali!", "caminhar lá!"},
["light"] = {"Use Luz", "Luz!", "Use Luz Aqui!", "Ilumine  este lugar!"},
["dig"] = {"Abra esse buraco!", "Cave esse buraco!", "abra o buraco!", "Use Cavar"},
["blink"] = {"Teletransporte-se lá!", "blink lá!", "blink!", "teleport!"},
["ride"] = {"Deixe-me montar em você.", "vamos cavalgar!", "Deixe-me montar em você.", "Vamos andar!"},
["fly"] = {"vamos voar!", "deixe-me montar em você"} ,
["untransform"] = {"Volte ao normal!", "Transformar em si mesmo novamente!", "Pare transformação!"},
["headbutt"] = {"headbutt na quela arvore", "headbutt na quela arvore!", "Use o headbutt"}, 
["levitate_fly"] = {"Vamos levitar!", "deixe-me montar em você", "Vamos assustar alguém! Levite."},  --alterado v1.8
}
...
local proibidossempre = {"Articuno", "Shiny Mantine", "Shiny Abra", "Shiny Tangrowth", "Shiny Kingdra", "Shiny Houndoom", "Shiny Milotic", "Shiny Tropius", "Mega Gengar", "Mega Ampharos", "Mega Alakazam", "Mega Aerodactyl", "Mega Slowbro", "Mega Scizor", "Mega Blastoise", "Mega CharizardX", "Mega CharizardY", "Mega Blaziken", "Mega Lucario", "Mega Glalie", "Mega Tyranitar", "Shiny Lucario", "Shiny Scizor", "Shiny Wobuffet", "Shiny Electivire", "Shiny Magmortar", "Ho-oh", "Celebi", "Moltres", "Zapdos", "Suicune", "Entei", "Raikou", "Lugia", "Mewtwo", "Mew", "Shiny Rhydon", "Shiny Ariados", "Shiny Magneton", "Shiny Ninetales", "Shiny Politoed", "Shiny Stantler", "Shiny Dodrio", "Shiny Espeon", "Shiny Umbreon"} -- Nunca permitir
