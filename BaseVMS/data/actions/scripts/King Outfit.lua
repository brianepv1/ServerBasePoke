...
local config = {
    velocidadeDaSuaBike = 750, -- A volocidade da bike (1-9)
    outfitMale = 2042, -- Outfit male
    outfitFemale = 2224, -- Outfit female
...
function onUse(cid, item, itemEx, fromPosition, toPosition)
    ...
    if ctrl < 1 then
        ...
        doPlayerSendCancel(cid, "Você não pode usar o Demonic Outfit enquanto está no Fly/Ride.")
    end
return true
end