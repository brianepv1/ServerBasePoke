...
local t = {
{uid=4650, storage=15354, recompensa=11447, mensagem="Parabéns, você ganhou uma Fire Stone."},
{uid=4651, storage=15354, recompensa=11441, mensagem="Parabéns, você ganhou uma Leaf Stone."},
{uid=4652, storage=15354, recompensa=11442, mensagem="Parabéns, você ganhou uma Water Stone."}
}
