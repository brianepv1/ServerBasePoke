...
local t = {
{uid=4643, storage=15354, recompensa=11447, mensagem="Parabéns, você ganhou uma Fire Stone."},
{uid=4644, storage=15354, recompensa=11441, mensagem="Parabéns, você ganhou uma Leaf Stone."},
{uid=4645, storage=15354, recompensa=11442, mensagem="Parabéns, você ganhou uma Water Stone."}
}

if item.uid == t[1].uid and getPlayerStorageValue(cid, t[1].storage) == -1 then
doPlayerAddItem(cid, t[1].recompensa, 2)
...
doPlayerAddItem(cid, t[2].recompensa, 2)
...
doPlayerAddItem(cid, t[3].recompensa, 2)
