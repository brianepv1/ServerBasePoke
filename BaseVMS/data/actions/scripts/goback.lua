...
if item.itemid == usando then                           
	...
	-- Sistema de Guardian - Thalles Vitor
    local summon = getCreatureSummons(cid)
    if summon[1] and getPlayerStorageValue(summon[1], 239192936) >= 1 then
        z = getCreatureSummons(cid)[2]
    end

    if summon[2] and getPlayerStorageValue(summon[2], 239192936) >= 1 then
        z = getCreatureSummons(cid)[1]
    end
