...
local config = {
    outfitMale = 5987, -- Outfit male
    outfitFemale = 5986, -- Outfit female
...
function onUse(cid, item, itemEx, fromPosition, toPosition)
	...
	doPlayerSendCancel(cid, "Voce nao pode usar o Hoverboard enquanto surfa.")
		return false
	 end
