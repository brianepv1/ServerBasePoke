...
rank = {"a Wingeon Cloud", "a Wingeon Wind","a Wingeon Sky","a Wingeon Falcon","a Wingeon Dragon"}


		if msgcontains(msg, 'clan') or msgcontains(msg, 'Clan') then

		   if getPlayerStorageValue(cid, 86228) == 4 then
		...
		elseif (msgcontains(msg, 'yes') or msgcontains(msg, 'Yes')) and talkState[talkUser] == 2 then
		   ...
		   setPlayerStorageValue(cid, 86228, 4)
