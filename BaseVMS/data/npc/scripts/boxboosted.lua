...
local node1 = keywordHandler:addKeyword({'quest'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Nessa {quest} possui monstros muito fortes você esta pronto para enfrenta-los?? Se estiver com Masterball deixe-a no CP....ah você so tem 60 minutos de tempo para realizar essa quest diga yes'})
