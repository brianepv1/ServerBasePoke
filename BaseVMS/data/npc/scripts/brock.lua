...
local pokemons = {
{name = "Onix", optionalLevel = 400, sex = SEX_MALE, nick = "", ball = "normal"},
{name = "Rhydon", optionalLevel = 400, sex = SEX_MALE, nick = "", ball = "normal"},   --alterado v1.3
{name = "Aerodactyl", optionalLevel = 400, sex = SEX_MALE, nick = "", ball = "normal"},
{name = "Steelix", optionalLevel = 400, sex = SEX_MALE, nick = "", ball = "normal"},
{name = "Shiny Golem", optionalLevel = 500, sex = SEX_MALE, nick = "", ball = "normal"},
}
