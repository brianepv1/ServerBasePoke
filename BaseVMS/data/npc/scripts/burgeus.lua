...
if(doPlayerRemoveItem(cid, 18918, 100) == true) then  
selfSay('Obrigado!', cid) 
...
if(doPlayerRemoveItem(cid, 18918, 900) == true) then  
selfSay('Obrigado!', cid) 
...
if(doPlayerRemoveItem(cid, 18918, 300) == true) then  
selfSay('Obrigado!', cid) 
...
if(doPlayerRemoveItem(cid, 18918, 400) == true) then  
selfSay('Obrigado!', cid) 
...
if(doPlayerRemoveItem(cid, 18918, 600) == true) then  
selfSay('Obrigado!', cid) 
...
if(doPlayerRemoveItem(cid, 18918, 1200) == true) then  
selfSay('Obrigado!', cid) 
...
if(doPlayerRemoveItem(cid, 18918, 800) == true) then  
selfSay('Obrigado!', cid) 
...
if(doPlayerRemoveItem(cid, 18918, 1500) == true) then  
selfSay('Obrigado!', cid) 
