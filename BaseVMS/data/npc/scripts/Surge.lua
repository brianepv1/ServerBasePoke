...
local pokemons = {
{name = "Raichu", optionalLevel = 400, sex = SEX_FEMALE, nick = "", ball = "normal"},
{name = "Electrode", optionalLevel = 400, sex = SEX_FEMALE, nick = "", ball = "normal"},
{name = "Electabuzz", optionalLevel = 400, sex = SEX_FEMALE, nick = "", ball = "normal"},
{name = "Ampharos", optionalLevel = 400, sex = SEX_MALE, nick = "", ball = "normal"},
{name = "Lanturn", optionalLevel = 400, sex = SEX_MALE, nick = "", ball = "normal"},
{name = "Electivire", optionalLevel = 400, sex = SEX_MALE, nick = "", ball = "normal"},
}
