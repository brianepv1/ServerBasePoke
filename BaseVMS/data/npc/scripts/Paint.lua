...
npcHandler:setMessage(MESSAGE_GREET, 'Oi bitch,Bem vindo à minha loja de pintura |PLAYERNAME| Se quiser pintar sua ball fale {paint}!')
...
selfSay('Bitch '.. getCreatureName(cid) ..', mas você não tem dinheiro suficiente.', cid)
talkState = 0
end
else
