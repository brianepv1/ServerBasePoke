...
rank = {"a Psycraft Mind", "a Psycraft Brain","a Psycraft Scholar","a Psycraft Telepath","a Psycraft Medium"}


		if msgcontains(msg, 'clan') or msgcontains(msg, 'Clan') then

		   if getPlayerStorageValue(cid, 86228) == 7 then
		...
		elseif (msgcontains(msg, 'yes') or msgcontains(msg, 'Yes')) and talkState[talkUser] == 2 then
		   ...
		   setPlayerStorageValue(cid, 86228, 7)
