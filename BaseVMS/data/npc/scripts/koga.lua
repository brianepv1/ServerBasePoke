...
local pokemons = {
{name = "Arbok", optionalLevel = 750, sex = SEX_FEMALE, nick = "", ball = "normal"},
{name = "Nidoqueen", optionalLevel = 750, sex = SEX_FEMALE, nick = "", ball = "normal"},
{name = "Shiny Crobat", optionalLevel = 700, sex = SEX_MALE, nick = "", ball = "normal"},
{name = "Muk", optionalLevel = 700, sex = SEX_MALE, nick = "", ball = "normal"},
{name = "Weezing", optionalLevel = 700, sex = SEX_MALE, nick = "", ball = "normal"},
{name = "Nidoking", optionalLevel = 700, sex = SEX_MALE, nick = "", ball = "normal"},
}
