...
rank = {"an Orebound Sand", "an Orebound Rock","an Orebound Solid","an Orebound Hardskin","an Orebound Hero"}


		if msgcontains(msg, 'clan') or msgcontains(msg, 'Clan') then

		   if getPlayerStorageValue(cid, 86228) == 3 then
		...
		elseif (msgcontains(msg, 'yes') or msgcontains(msg, 'Yes')) and talkState[talkUser] == 2 then
		   ...
		   setPlayerStorageValue(cid, 86228, 3)
