...
local task = {
["Kayra"] = {{"Dragonite", 65}, {"Dragonair", 80}},
}
        ...
        if msgcontains(msg, 'task') or msgcontains(msg, 'Task') then
           if isMyTaskComplete(cid, getNpcCid()) then
              ...
              doPlayerAddExperience(cid, 1600000)  --premio -- Quase 2 Leveis no nivel 131 ~~ 'testado'
              ...
              selfSay("Then, is a simple task, i want to you kill {65 Dragonites, 80 Dragonairs,}, you accept the task?", cid)
