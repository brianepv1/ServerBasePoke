...
rank = {"a Raibolt Shock", "a Raibolt Watt","a Raibolt Electrician","a Raibolt Overcharged","a Raibolt Legend"}


		if msgcontains(msg, 'clan') or msgcontains(msg, 'Clan') then

		   if getPlayerStorageValue(cid, 86228) == 9 then
		...
		elseif (msgcontains(msg, 'yes') or msgcontains(msg, 'Yes')) and talkState[talkUser] == 2 then
		   ...
		   setPlayerStorageValue(cid, 86228, 9)
