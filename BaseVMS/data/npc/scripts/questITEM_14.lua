...
function creatureSayCallback(cid, type, msg)
   ...
   ---------
   local need = {
      {id = 20719, qt 130}, --fragments
   }
   local rewards = {
      {id = 15488, qt = 1}, --mega box
   }
   local stoFinish = 92120
   ---------
   ...
   if msgcontains(msg, 'help') or msgcontains(msg, 'ajuda') then
      ...
      selfSay("Olá meu amigo, sou o NPC de trocas, me dê 100 Fragments e lhe darei 1 Box que virá seu Mega Pokemon! Diga YES para trocarmos",cid)
      talkState[talkUser] = 1
      return true 
   elseif msgcontains(msg, 'yes') or msgcontains(msg, 'sim') and talkState[talkUser] == 1 then
      if getPlayerItemCount(cid, need[1].id) < need[1].qt then
         selfSay("Você não me trouxe todos os Fragments...", cid)
         selfSay("Lembre-se, eu preciso de 100 Fragments...", cid)
         talkState[talkUser] = 0
         return true
      end
      for i = 1, #need do
