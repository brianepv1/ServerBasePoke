...
local cfg = {
          toPos = {x=2086, y=1357, z=7}, -- Posição que o jogador sera teleportado
...
function creatureSayCallback(cid, type, msg)
          ...
          if msgcontains(msg, 'altaria land') or msgcontains (msg, 'Altaria Land') then
                    selfSay('You are sure you want to travel to Altaria Land?', cid)
