...
if isPlayer(thing.uid) then     --player
    table.insert(str, "You see the Player: "..string.lower(getCreatureName(thing.uid))..".\n")
	 table.insert(str, "He is Pokemon Trainer (Level: "..string.lower(getPlayerLevel(cid))..").")
	 doPlayerSendTextMessage(cid, MESSAGE_INFO_DESCR, table.concat(str))
return false
end
