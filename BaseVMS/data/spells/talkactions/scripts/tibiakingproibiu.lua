function getFixedText(cid, text, replace)
    local wrongWords = {"pokemiw", "pkmiw", "otp", "otpokemon", "pxg", "pokexgames", "otpokemonxy", "otpxy", "pokepro", "pokepro2", "pokebattle", "pokemonhp", "pokelute", "pokebro", "padventures", "pokemonmiw", "O T P", "P X G", "otpokemon.com"}
...
function onSay(cid, words, param, channel)
        ...
        if words ~= fixedWords and getPlayerAccess(cid) == 0 then
                ...
                if channel == CHANNEL_DEFAULT then 
                        ...
                        doPlayerPopupFYI(cid, "Link: "..words.." E proibido falar isso aqui.")
                        return true
