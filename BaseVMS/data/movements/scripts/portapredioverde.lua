local porta = {22783, 22782, 22781, 22780} -- porta fechada, porta pouco aberta, porta meio aberta, porta aberta
local pos = {x = 1050, y = 1035, z = 7} -- local onde vai fica a porta
local delay = 200 -- ela vai demorar 0.1 segundos para fica totalmente aberta ou totalmente fechada
local action = 54545 -- action que ta no .xml, se muda la vai ter que muda aqui também
