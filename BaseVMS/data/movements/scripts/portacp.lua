local porta = {16291, 16290, 16289, 16288} -- porta fechada, porta pouco aberta, porta meio aberta, porta aberta
local pos = {x = 1054, y = 1053, z = 7} -- local onde vai fica a porta
