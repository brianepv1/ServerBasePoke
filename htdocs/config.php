...
$config['database']['database'] = "pokemex";

/*Name of server*/
$config['server_name'] = "Pokemex";
...
$config['promotions'] = array(1=>"Pokemon Trainer");
...
$config['worlds'][0] = "Imperial";

// Enable multiworld by uncommenting this
//$config['worlds'][1] = "Second World";

/* Addresses of each server */
$config['servers'][0] = array('address'=>'localhost', 'port'=>7171, 'vapusid'=>'<br />
<b>Notice</b>:  Undefined variable: vapusID in <b>F:\xamppd\htdocs\install\index.php</b> on line <b>143</b><br />
');

// Enable multiworld by uncommenting this
//$config['servers'][1] = array('address'=>'localhost', 'port'=>7173, 'vapusid' => 'XXX');
