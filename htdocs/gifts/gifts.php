...
$categories = array(1 => 'Account', 2 => 'Items', 3 => 'Containers with Items', 4 => 'Addon Items');
if ($_SESSION['logged'] == 1) {
	...
	if ($action == '') {
		...
		alert("
						<b>ATENÇÃO: NÃO EFETUE UMA COMPRA SEM ESPAÇO NA BACKPACK. NÃO NOS RESPONSABILISAMOS POR POSSIVEIS PERDAS POR CONTA DISSO!</b><br>
						</b><br>
						<b>ATENÇÃO: NÃO EFETUE UMA COMPRA SEM ESPAÇO NA BACKPACK. NÃO NOS RESPONSABILISAMOS POR POSSIVEIS PERDAS POR CONTA DISSO!</b><br>
						</b><br>
						<b>ATENÇÃO: NÃO EFETUE UMA COMPRA SEM ESPAÇO NA BACKPACK. NÃO NOS RESPONSABILISAMOS POR POSSIVEIS PERDAS POR CONTA DISSO!</b><br>
						...
						<b>ATTENTION: DO NOT MAKE A PURCHASE WITHOUT SPACE ON THE BACKPACK. WE DO NOT RESPONSIBLE FOR POSSIBLE LOSSES ON THE ACCOUNT OF THESE</b><br>
		</b><br><br>All categories, <b>except for 'Containers with Items'</b>:<br><br>Receiver need to have space on his/her <b>BACKPACK</b> to receive item.");
	...
	elseif ($action == 'buy') {
		...
		if (!$product) {
			...
			echo '<div align="right"><a href="'.WEBSITE.'/index.php/p/v/gifts">Voltar para o shop</a></div>';
		}
		else {
					...
					if($info['type'] != '4') {
						if($_POST['other_char']) {
							if($SQL->query('SELECT * FROM players WHERE name = "'.$_POST['other_char'].'"')->fetch()) {
								...
								echo '<div align="right"><a href="'.WEBSITE.'/index.php/p/v/gifts/buy/'.$info['id'].'">Voltar para o shop</a></div>';
								$send = false;
							}
						}
						else {
